...
```{r}
df.OSGCN <- read_excel("/Users/zhengyuanrui/Desktop/os_develop/Open Scholarship Grassroots Community Networks.xlsx") %>% dplyr::select(...1, developed, country) %>% rename("organization" = ...1)
df.OSGCN$country <- str_squish(df.OSGCN$country)
df.OSGCN %>% filter(is.na(country))
```
```{r}
...
## osambassador
```{r}
df.osam <- read_excel("/Users/zhengyuanrui/Desktop/os_develop/osambassador.xlsx") %>% 
...
## UK
```{r}
df.UK <- read_excel("/Users/zhengyuanrui/Desktop/os_develop/uk.xlsx") %>% mutate(rep_code = case_when(
  country == "UK" ~ "GBR", 
  country == "swiss" ~ "CHE",
    country == "Sweden" ~ "SWE",
    country =="German" ~ "DEU",
...
```{r}
df.tea <- read_excel("/Users/zhengyuanrui/Desktop/os_develop/ReproducibiliTea.xlsx") %>% mutate(rep_code = case_when(
  country == "Egypt" ~ "EGY", 
  country == "Hungary" ~ "HUN", 
  country == "USA" ~ "USA", 
  country == "United Kingdom"~ "GBR", 
...
## SIPS
```{r}
df.SIPS <- read_xlsx("/Users/zhengyuanrui/Desktop/os_develop/SIPS.xlsx") %>% 
  mutate(rep_code = case_when(
  country == "Egypt" ~ "EGY", 
  country == "Hungary" ~ "HUN", 
  country == "USA" ~ "USA", 
...
```{r}
df_all <- rbind(df.UK[c("country", "rep_code", "developed", "platform")], df.osam[c("country", "rep_code", "developed", "platform")], df.tea[c("country", "rep_code", "developed", "platform")], df.OSGCN[c("country", "rep_code", "developed", "platform")], df.SIPS[c("country", "rep_code", "developed", "platform")], df.OSGCN[c("country", "rep_code", "developed", "platform")])
```
